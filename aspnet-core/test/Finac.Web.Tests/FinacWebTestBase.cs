...
{
    public abstract class FinacWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FinacWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FinacWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FinacDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FinacDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FinacDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FinacDbContext, Task<T>> func)
        {
            T result;
